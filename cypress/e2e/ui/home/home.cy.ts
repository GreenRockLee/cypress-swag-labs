...
describe('Cart functionality', () => {
  ...
  it('should correctly handle adding, removing and persisting multiple cart products', () => {
    ...
    homePage.elements.title().should('be.visible').should('have.text', 'Products')
    homePage.elements.shoppingCartButton().should('be.visible')
    homePage.elements.sideBurgerMenuButton().should('be.visible')
    homePage.elements.productsFilter().should('be.visible')
